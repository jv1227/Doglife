      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="home.php" class="h2 mb-0"><strong>Ani</strong>+<span class="text-primary"></span> </a></h1>
          </div>
        ...
        <div class="row no-gutters">
          <div class="col-lg-6">
            <form action="#" class="p-5 contact-form">
              <br><br></form>
              <h2 class="h4 mb-5 heading">Adotar</h2> 

<form method="post" action="salvardados.php">

              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label for="fname">Nome animal</label>
                  <input type="text" name="nomeanimal"  placeholder="nomeanimal" value="Rochelle" readonly="readonly" class="form-control"/>
                </div>
                <div class="col-md-6">
                  <label for="lname">Seu nome</label>
              ...
              <div class="row form-group">
               ...
               <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="telefone"  placeholder="+55 (DDD)..." />
                </div>
              </div>
        ...
        <br>
             ...
             <ul class="actions">
               <center><div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Adotar" class="btn btn-dark btn-md text-white">
                </div>
              </div></ul></center>
          ...
          <div class="col-lg-6">
            <div class="row justify-content-center align-items-center h-100">
              <div class="col-lg-6 text-center heading-section mb-5 align-self-center">
                ...
                <h2 class=" mb-5 text-black">Adoção</h2>
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-5">
                ...
                <p>Clínica médica veterinária</p>
              </div>
